"""Tests to ensure that the values for a low risk NEWS ob are correct"""
...
class TestPatientPageVisualisationWithLowRiskObsData(TestVisualisationCommon):
    ...
    def test_chart_resp_rate_value(self):
        ...
        """
        self.assertEqual(self.graph_data['resp_rate'], '11/min',
    ...
    def test_news_score_value(self):
        ...
        """
        self.assertEqual(self.row_data[0][1], '1',
    ...
    def test_respiration_rate_value(self):
        ...
        """
        self.assertEqual(self.row_data[1][1], '11',
