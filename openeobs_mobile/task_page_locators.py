...
CLINICAL_RISK = (By.CSS_SELECTOR, '#submit_observation strong')
CONFIRM_ACTION_TAKEN = (By.CSS_SELECTOR, '#obsForm > p')
RELATED_TASK_LIST = (By.CSS_SELECTOR, '#submit_success > .dialogContent > .menu > li > a')
CONFIRM_AMBULANCE = (By.CSS_SELECTOR, '#obsForm > p:nth-child(2)')
CANCEL_TASK = (By.CSS_SELECTOR, '#cancel_reasons > ul > li:nth-child(2) > a')
CANCEL_POPUP = (By.CSS_SELECTOR, '#cancel_reasons')
CANCEL_SELECT = (By.CSS_SELECTOR, '#cancel_reasons > div > select')
CANCEL_COMPLETE = (By.CSS_SELECTOR, '#cancel_success > div > p')
FREQUENCY_SELECT = (By.ID, 'frequency')
